...
<%
	//セッションスコープから回答データを取得
	String answer;
	answer = (String) session.getAttribute("q15answer");
%>
<%
...
<p>
	...
	<i class="bi bi-robot"></i><i class="bi bi-chat-text"></i><%= words.get(14).getOn_java() %><br>
</p>
	
<form action="/MyProject/LearnEnglishServlet?action=LookBack3" method="post">
