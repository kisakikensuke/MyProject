...
<%
	//セッションスコープから回答データを取得
	String answer;
	answer = (String) session.getAttribute("q12answer");
%>
<%
...
<p>
	...
	<i class="bi bi-robot"></i><i class="bi bi-chat-text"></i><%= words.get(11).getOn_java() %><br>
</p>
	
<form action="/MyProject/LearnEnglishServlet?action=q13" method="post">
