...
<%
	//セッションスコープから回答データを取得
	String answer;
	answer = (String) session.getAttribute("q14answer");
%>
<%
...
<p>
	...
	<i class="bi bi-robot"></i><i class="bi bi-chat-text"></i><%= words.get(13).getOn_java() %><br>
</p>
	
<form action="/MyProject/LearnEnglishServlet?action=q15" method="post">
