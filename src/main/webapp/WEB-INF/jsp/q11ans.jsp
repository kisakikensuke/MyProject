...
<%
	//セッションスコープから回答データを取得
	String answer;
	answer = (String) session.getAttribute("q11answer");
%>
<%
...
<p>
	...
	<i class="bi bi-robot"></i><i class="bi bi-chat-text"></i><%= words.get(10).getOn_java() %><br>
</p>
	
<form action="/MyProject/LearnEnglishServlet?action=q12" method="post">
