...
<%
	//セッションスコープから回答データを取得
	String answer;
	answer = (String) session.getAttribute("q10answer");
%>
<%
...
<p>
	...
	<i class="bi bi-robot"></i><i class="bi bi-chat-text"></i><%= words.get(9).getOn_java() %><br>
</p>
	
<form action="/MyProject/LearnEnglishServlet?action=LookBack2" method="post">
