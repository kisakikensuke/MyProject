...
<%
	//セッションスコープから回答データを取得
	String answer;
	answer = (String) session.getAttribute("q6answer");
%>
<%
...
<p>
	...
	<i class="bi bi-robot"></i><i class="bi bi-chat-text"></i><%= words.get(5).getOn_java() %><br>
</p>
	
<form action="/MyProject/LearnEnglishServlet?action=q7" method="post">
